...
export default function WorkPage() {
  return (
    <PageShell
      ...
      title={
        <>
          The defensible slice. <em style={{ fontStyle: 'italic', color: 'var(--color-amber)' }}>The rest by request.</em>
        </>
      }
    ...
    >
      <div style={{ padding: 'clamp(64px, 10vh, 120px) clamp(24px, 6vw, 96px)' }}>
        {WORK.map((era) => (
          <section key={era.era} style={{ marginBottom: 'clamp(80px, 12vh, 140px)' }}>
