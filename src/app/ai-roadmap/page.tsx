...
export const metadata: Metadata = {
  title: 'The 90-Day AI Roadmap for Indonesia · zapleo',
  description:
  ...
  alternates: { canonical: 'https://zapleo.com/ai-roadmap/' },
};
...
export default function AIRoadmapPage() {
  return (
    <>
      {/* ============================================================
          Top nav bar — minimal, back to zapleo
          ============================================================ */}
      <header
        style={{
      ...
      <main>
        ...
        >
          ...
          <PhaseBlock
            ...
            items={[
              ...
              'Or a structured Jakarta bootcamp (see resource page).',
            ]}
          />
          <PhaseBlock
            label="Apply"
        ...
        >
          <div style={{ marginTop: 48, display: 'grid', gap: 'clamp(12px, 1.5vw, 18px)' }}>
            ...
            <ToolCard
              ...
              badge="JAKARTA"
              badgeAccent="rust"
              body="Hacktiv8, Dibimbing, Purwadhika, Dicoding, or IT STEP Indonesia (itstep.id) for fixed-schedule, in-person learning with a certificate."
            />
          </div>
        ...
        {/* ============================================================
            PROOF — what unicorns actually ask for
            ============================================================ */}
        <SectionBlock
          eyebrow="Proof"
          title={
        ...
        {/* ============================================================
            AT A GLANCE — week-by-week timeline
            ============================================================ */}
        <SectionBlock
          eyebrow="At a glance"
          title={
                  ...
                  style={
                    {
                      '--stagger': `${i * 50}ms`,
                      display: 'grid',
                      gridTemplateColumns: '4px 140px 1fr',
        ...
        {/* ============================================================
            FINAL CTA — "You have the map. Now walk it."
            ============================================================ */}
        <section
          style={{
            position: 'relative',
      ...
      >
        ...
        <span className="mono" style={{ fontSize: 11, letterSpacing: '0.18em', color: 'var(--color-ink-ghost)' }}>
          © {new Date().getFullYear()} · AI-Dima · Jakarta → Asia → the world
        </span>
      </footer>
    </>
  );
